...
blackouts = genfromtxt('input/news_count.txt')  # todo: data source
...
def plot_basics(data, data_inst, fig, units):
    ...
    fig.annotate("a", annotate_coord, xycoords="axes fraction", fontproperties=panel_label_font)
