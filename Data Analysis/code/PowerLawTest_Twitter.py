...
def plot_basics(data, data_inst, fig, units):
    ...
    ax2 = fig.add_subplot(n_graphs, n_data, n_data + data_inst, sharex=ax1,visible=False)
    ...
    fit.power_law.plot_pdf(ax=ax3, linestyle='--', color='g', label="power law fit\n(opt-min)")
    fit.exponential.plot_pdf(ax=ax3, linestyle='--', color='r', label="exponential fit\n(opt-min)")
...
data_inst = 3
units = "Population Coverage of Rumors\non Twitter"
